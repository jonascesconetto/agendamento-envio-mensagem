...
class App extends Component {
    ...
    createMenu() {
        this.menu = [
            ...
            { label: 'Agendamento', icon: 'pi pi-calendar', command: () => { window.location = '#/comunicacao/agendamento' } }
        ]
    }
        ...
        return (
            <div className={wrapperClass} onClick={this.onWrapperClick}>
                ...
                <div className="layout-main">
                    ...
                    <Route path="/comunicacao/agendamento" exact component={AgendamentoPage} />
                </div>
